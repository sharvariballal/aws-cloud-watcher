...
import { Cloud, Lock, Mail, User, Eye, EyeOff, Loader2, ArrowLeft, Building2 } from 'lucide-react';
...
export default function Register({ onNavigate }: RegisterProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err?.message || 'Handshake failed. Ensure parameters are valid.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="w-full max-w-md relative z-10 space-y-8">
        ...
        <div className="text-center">
          ...
          <h2 className="mt-4 text-2xl font-bold font-display tracking-tight text-white">
            Create IAM Console Seat
          </h2>
          <p className="mt-1.5 text-xs text-slate-400 font-mono">
            Register your local credentials to spin up monitoring metrics
          </p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl bg-slate-950 border border-slate-800/80 focus:border-orange-500 focus:outline-none pl-10 pr-4 py-2.5 text-sm text-white placeholder:text-slate-600 transition"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl bg-slate-950 border border-slate-800/80 focus:border-orange-500 focus:outline-none pl-10 pr-4 py-2.5 text-sm text-white font-mono placeholder:text-slate-600 transition"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl bg-slate-950 border border-slate-800/80 focus:border-orange-500 focus:outline-none pl-10 pr-4 py-2.5 text-sm text-white placeholder:text-slate-600 transition"
                  placeholder="CloudOps Solutions"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl bg-slate-950 border border-slate-800/80 focus:border-orange-500 focus:outline-none pl-10 pr-10 py-2.5 text-sm text-white font-mono placeholder:text-slate-600 transition"
            ...
            >
              {loading ? (
                <>
                  ...
                  <span>Registering Cognito Identity...</span>
                </>
              ) : (
                <span>Register Console Seat</span>
              )}
            </button>
          </form>
        ...
        <div className="bg-slate-900/40 rounded-xl border border-slate-800/60 p-4 text-[10px] text-slate-500 font-mono leading-normal">
          <span className="text-slate-400 font-bold block mb-1">AWS Cognito Sign Up:</span>
          Connecting real authentication is done using Cognito&apos;s custom signup actions, which can trigger verification emails with verification codes automatically.
        </div>
      </div>
    </div>
  );
